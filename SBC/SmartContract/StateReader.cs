...
namespace SBC.SmartContract
{
    public class StateReader : InteropService, IDisposable
    {
        ...
        public StateReader()
        {
            Register("SBC.Runtime.GetTrigger", Runtime_GetTrigger);
            Register("SBC.Runtime.CheckWitness", Runtime_CheckWitness);
            Register("SBC.Runtime.Notify", Runtime_Notify);
            Register("SBC.Runtime.Log", Runtime_Log);
            Register("SBC.Runtime.GetTime", Runtime_GetTime);
            Register("SBC.Runtime.Serialize", Runtime_Serialize);
            Register("SBC.Runtime.Deserialize", Runtime_Deserialize);
            Register("SBC.Blockchain.GetHeight", Blockchain_GetHeight);
            Register("SBC.Blockchain.GetHeader", Blockchain_GetHeader);
            Register("SBC.Blockchain.GetBlock", Blockchain_GetBlock);
            Register("SBC.Blockchain.GetTransaction", Blockchain_GetTransaction);
            Register("SBC.Blockchain.GetAccount", Blockchain_GetAccount);
            Register("SBC.Blockchain.GetValidators", Blockchain_GetValidators);
            Register("SBC.Blockchain.GetAsset", Blockchain_GetAsset);
            Register("SBC.Blockchain.GetContract", Blockchain_GetContract);
            Register("SBC.Header.GetIndex", Header_GetIndex);
            Register("SBC.Header.GetHash", Header_GetHash);
            Register("SBC.Header.GetVersion", Header_GetVersion);
            Register("SBC.Header.GetPrevHash", Header_GetPrevHash);
            Register("SBC.Header.GetMerkleRoot", Header_GetMerkleRoot);
            Register("SBC.Header.GetTimestamp", Header_GetTimestamp);
            Register("SBC.Header.GetConsensusData", Header_GetConsensusData);
            Register("SBC.Header.GetNextConsensus", Header_GetNextConsensus);
            Register("SBC.Block.GetTransactionCount", Block_GetTransactionCount);
            Register("SBC.Block.GetTransactions", Block_GetTransactions);
            Register("SBC.Block.GetTransaction", Block_GetTransaction);
            Register("SBC.Transaction.GetHash", Transaction_GetHash);
            Register("SBC.Transaction.GetType", Transaction_GetType);
            Register("SBC.Transaction.GetAttributes", Transaction_GetAttributes);
            Register("SBC.Transaction.GetInputs", Transaction_GetInputs);
            Register("SBC.Transaction.GetOutputs", Transaction_GetOutputs);
            Register("SBC.Transaction.GetReferences", Transaction_GetReferences);
            Register("SBC.Transaction.GetUnspentCoins", Transaction_GetUnspentCoins);
            Register("SBC.InvocationTransaction.GetScript", InvocationTransaction_GetScript);
            Register("SBC.Attribute.GetUsage", Attribute_GetUsage);
            Register("SBC.Attribute.GetData", Attribute_GetData);
            Register("SBC.Input.GetHash", Input_GetHash);
            Register("SBC.Input.GetIndex", Input_GetIndex);
            Register("SBC.Output.GetAssetId", Output_GetAssetId);
            Register("SBC.Output.GetValue", Output_GetValue);
            Register("SBC.Output.GetScriptHash", Output_GetScriptHash);
            Register("SBC.Account.GetScriptHash", Account_GetScriptHash);
            Register("SBC.Account.GetVotes", Account_GetVotes);
            Register("SBC.Account.GetBalance", Account_GetBalance);
            Register("SBC.Asset.GetAssetId", Asset_GetAssetId);
            Register("SBC.Asset.GetAssetType", Asset_GetAssetType);
            Register("SBC.Asset.GetAmount", Asset_GetAmount);
            Register("SBC.Asset.GetAvailable", Asset_GetAvailable);
            Register("SBC.Asset.GetPrecision", Asset_GetPrecision);
            Register("SBC.Asset.GetOwner", Asset_GetOwner);
            Register("SBC.Asset.GetAdmin", Asset_GetAdmin);
            Register("SBC.Asset.GetIssuer", Asset_GetIssuer);
            Register("SBC.Contract.GetScript", Contract_GetScript);
            Register("SBC.Storage.GetContext", Storage_GetContext);
            Register("SBC.Storage.Get", Storage_Get);
            Register("SBC.Storage.Find", Storage_Find);
