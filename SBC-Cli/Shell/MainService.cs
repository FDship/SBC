using SBC.Consensus;
using SBC.Core;
using SBC.Implementations.Blockchains.LevelDB;
using SBC.Implementations.Wallets.EntityFramework;
using SBC.Implementations.Wallets.NEP6;
using SBC.IO;
using SBC.IO.Json;
using SBC.Network;
using SBC.Network.Payloads;
using SBC.Network.RPC;
using SBC.Services;
...
namespace SBC.Shell
{
    internal class MainService : ConsoleServiceBase
    {
        ...
        protected override string Prompt => "sbc";
        public override string ServiceName => "SBC-CLI";
        ...
        private void LevelDBBlockchain_ApplicationExecuted(object sender, ApplicationExecutedEventArgs e)
        {
            ...
            json["shipcoin"] = e.GasConsumed.ToString();
